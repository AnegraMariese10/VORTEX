//
// Generated file, do not edit! Created by nedtool 5.6 from apps/sateliteudpapp/packet-mariese-cenario/CloudMessage.msg.
//
...
Register_Class(CloudMessage)

CloudMessage::CloudMessage() : ::inet::FieldsChunk()
{
}

CloudMessage::CloudMessage(const CloudMessage& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
CloudMessage& CloudMessage::operator=(const CloudMessage& other)
{
...
void CloudMessage::copy(const CloudMessage& other)
{
...
void CloudMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void CloudMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
long CloudMessage::getTamanhoPacote() const
{
    return this->tamanhoPacote;
}

void CloudMessage::setTamanhoPacote(long tamanhoPacote)
{
    handleChange();
    this->tamanhoPacote = tamanhoPacote;
}

int CloudMessage::getPortaCarro() const
{
    return this->portaCarro;
}

void CloudMessage::setPortaCarro(int portaCarro)
{
    handleChange();
    this->portaCarro = portaCarro;
}

const char * CloudMessage::getClientAddr() const
{
    return this->clientAddr.c_str();
}

void CloudMessage::setClientAddr(const char * clientAddr)
{
    handleChange();
    this->clientAddr = clientAddr;
}

short CloudMessage::getTosEscolhido() const
{
    return this->tosEscolhido;
}

void CloudMessage::setTosEscolhido(short tosEscolhido)
{
    handleChange();
    this->tosEscolhido = tosEscolhido;
}

double CloudMessage::getDistAntenna() const
{
    return this->distAntenna;
}

void CloudMessage::setDistAntenna(double distAntenna)
{
    handleChange();
    this->distAntenna = distAntenna;
}

double CloudMessage::getVel() const
{
    return this->vel;
}

void CloudMessage::setVel(double vel)
{
    handleChange();
    this->vel = vel;
}

double CloudMessage::getTempoEntrada() const
{
    return this->tempoEntrada;
}

void CloudMessage::setTempoEntrada(double tempoEntrada)
{
    handleChange();
    this->tempoEntrada = tempoEntrada;
}

int CloudMessage::getRi() const
{
    return this->ri;
}

void CloudMessage::setRi(int ri)
{
    handleChange();
    this->ri = ri;
}

double CloudMessage::getCoordX() const
{
    return this->coordX;
}

void CloudMessage::setCoordX(double coordX)
{
    handleChange();
    this->coordX = coordX;
}

double CloudMessage::getCoordY() const
{
    return this->coordY;
}

void CloudMessage::setCoordY(double coordY)
{
    handleChange();
    this->coordY = coordY;
}

long CloudMessage::getId() const
{
    return this->id;
}

void CloudMessage::setId(long id)
{
    handleChange();
    this->id = id;
}

long CloudMessage::getIdObj() const
{
    return this->idObj;
}

void CloudMessage::setIdObj(long idObj)
{
    handleChange();
    this->idObj = idObj;
}

double CloudMessage::getTempDetect() const
{
    return this->tempDetect;
}

void CloudMessage::setTempDetect(double tempDetect)
{
    handleChange();
    this->tempDetect = tempDetect;
}

long CloudMessage::getObDetect() const
{
    return this->obDetect;
}

void CloudMessage::setObDetect(long obDetect)
{
    handleChange();
    this->obDetect = obDetect;
}

long CloudMessage::getPrioridade() const
{
    return this->prioridade;
}

void CloudMessage::setPrioridade(long prioridade)
{
    handleChange();
    this->prioridade = prioridade;
}

long CloudMessage::getTempoDeVida() const
{
    return this->TempoDeVida;
}

void CloudMessage::setTempoDeVida(long TempoDeVida)
{
    handleChange();
    this->TempoDeVida = TempoDeVida;
}

long CloudMessage::getObSize() const
{
    return this->obSize;
}

void CloudMessage::setObSize(long obSize)
{
    handleChange();
    this->obSize = obSize;
}

double CloudMessage::getCoordObjX() const
{
    return this->coordObjX;
}

void CloudMessage::setCoordObjX(double coordObjX)
{
    handleChange();
    this->coordObjX = coordObjX;
}

double CloudMessage::getCoordObjY() const
{
    return this->coordObjY;
}

void CloudMessage::setCoordObjY(double coordObjY)
{
    handleChange();
    this->coordObjY = coordObjY;
}

class CloudMessageDescriptor : public omnetpp::cClassDescriptor
{
  private:
  ...
  public:
    ...
    virtual ~CloudMessageDescriptor();
...
Register_ClassDescriptor(CloudMessageDescriptor)

CloudMessageDescriptor::CloudMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::CloudMessage)), "inet::FieldsChunk")
{
    propertynames = nullptr;
}

CloudMessageDescriptor::~CloudMessageDescriptor()
{
    delete[] propertynames;
}

bool CloudMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<CloudMessage *>(obj)!=nullptr;
}

const char **CloudMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *CloudMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int CloudMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 19+basedesc->getFieldCount() : 19;
}

unsigned int CloudMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *CloudMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int CloudMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *CloudMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **CloudMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CloudMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int CloudMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    CloudMessage *pp = (CloudMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *CloudMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CloudMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool CloudMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CloudMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *CloudMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
